...
十条[核心工程原则](AGENTS.md#核心工程原则)以用户结果与价值为起点，在同一根入口维护；方案要求融入架构设计、过程记录与完成判定，随共享规则一起分发。重要需求先填写[用户价值说明](docs/specs/_TEMPLATE/requirements.md#用户价值说明)，小改动可简写或引用已有记录。
